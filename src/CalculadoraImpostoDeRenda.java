...
public class CalculadoraImpostoDeRenda {
    public static void main(String[] args) {
        ...
        if (salario <= 1903.98) {
            ...
            System.out.println("Parcela dedutivél é de R$: " + (1903.99 * aliquota) / 100);
        } else if (salario >= 2826.66 && salario <= 3751.05) {
            aliquota = 15.0;
            System.out.println("Seu Salário foi de R$: " + salario + " Recebeu Alíquota de IRPF de " + aliquota + "%");
            System.out.println("Parcela dedutivél é de R$: " + (2826.66 * aliquota) / 100);
        } else if (salario >= 3751.06 && salario <= 4664.68) {
            aliquota = 22.5;
            System.out.println("Seu Salário foi de R$: " + salario + " Recebeu Alíquota de IRPF de " + aliquota + "%");
            System.out.println("Parcela dedutivél é de R$: " + (3751.06 * aliquota) / 100);
        }else{
            aliquota = 27.5;
            System.out.println("Seu Salário foi de R$: " + salario + " Recebeu Alíquota de IRPF de " + aliquota + "%");
            System.out.println("Parcela dedutivél é de R$: " + (4664.68 * aliquota) / 100);
        }
    }
}
